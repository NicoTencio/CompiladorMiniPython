...
package com.example.myapplication.generated;
  ...
  import com.example.myapplication.antlr4.DenterHelper;
...
public class archivosLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PyCOMA", "DOSPUN", "COMA", "RIGHTCOR", "LEFTCOR", "RIGHTKEY", "LEFTKEY", 
			"IGUAL", "PIZQ", "PDER", "MENORQUE", "MAYORQUE", "MENORIGUAL", "MAYORIGUAL", 
			"IGUALIGUAL", "SUMAR", "RESTAR", "SUM", "SUB", "MUL", "DIV", "GUIONBAJO", 
			"DEF", "IF", "WHILE", "RETURN", "PRINT", "LEN", "ELSE", "FOR", "IN", 
			"SPACE", "COMILLASSIMPLES", "COMILLAS", "ID", "INT", "FLOAT", "CHAR", 
			"STRING", "NEWLINE", "COMMENT", "COMENTARIO", "TOKENEXTRA", "LETTER", 
			"DIGIT", "ESC"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CHAR", "STRING", "NEWLINE", "COMMENT", "COMENTARIO", "TOKENEXTRA"
		};
	}
	...
	public archivosLexer(CharStream input) {
		super(input);
